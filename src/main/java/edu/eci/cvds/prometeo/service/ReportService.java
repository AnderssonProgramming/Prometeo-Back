...
public interface ReportService {
     ...
     * @return Report data as a byte array
     */
    byte[] generateUserProgressReport(UUID userId, LocalDate startDate, LocalDate endDate, String format);
     ...
     * @return Report data as a byte array
     */
    byte[] generateGymUsageReport(LocalDate startDate, LocalDate endDate, String groupBy, String format);
     ...
     * @return Report data as a byte array
     */
    byte[] generateTrainerReport(Optional<UUID> trainerId, LocalDate startDate, LocalDate endDate, String format);
